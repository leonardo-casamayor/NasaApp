...
struct NASAColors {
    static let NASAPrimary = (Color(#colorLiteral(red: 0.07546737045, green: 0.241075635, blue: 0.5692119598, alpha: 1)))
    static let NASAGradientStop = (Color(#colorLiteral(red: 0.1038304258, green: 0.3395711, blue: 0.8195102927, alpha: 1)))
    static let NASAPrimaryText = Color.white
}
